...
<body>
    ...
    <section class="statistik-chart" style="padding: 20px 100px;">
        <h2 style="text-align: center; margin-bottom:5px; color: #3d1f00;">Pola Pengunjung</h2>
        <div class="chart-container">
            <div class="jumlah-buku-group" style="padding: 10px 50px;">
                ...
                <div class="jumlah-item">
                    ...
                    <div class="jumlah-label">Jumlah Exempar</div>
                </div>
                <div class="jumlah-item">
            ...
            <iframe
                src="https://lookerstudio.google.com/embed/reporting/2d57c2be-6dd6-490a-a34c-4d40829ce214/page/2KjJF"
                frameborder="0"
                allowfullscreen
                sandbox="allow-storage-access-by-user-activation allow-scripts allow-same-origin allow-popups allow-popups-to-escape-sandbox"
                style="width: 100%; min-height: 680px; border-radius: 10px; margin-bottom: 60px; border: none;">
            </iframe>
        </div>
    </section>
